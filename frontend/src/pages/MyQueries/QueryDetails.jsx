            ...
            >
              ...
              <div className="rounded-2xl border border-blue-100 bg-blue-50/50 p-5 text-center">
                ...
                <p className="mt-3 text-sm font-medium text-slate-600">
                  No query documents are currently available
                  through this query-details API.
                </p>

                <p className="mt-2 text-xs leading-relaxed text-slate-400">
                  Document listing and viewing will be connected
                  during the Document Integration phase.
                </p>
              </div>
            </motion.div>
